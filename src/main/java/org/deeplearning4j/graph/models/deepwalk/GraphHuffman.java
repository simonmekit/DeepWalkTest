...
public class GraphHuffman implements BinaryTree {
    ...
    private static class Node implements Comparable<Node> {
        ...
        private Node(int vertexIdx, long count, Node left, Node right) {
    ...
    public long getCode(int vertexNum) {
        return codes[vertexNum-1];
    }

    @Override
    public int getCodeLength(int vertexNum) {
        return codeLength[vertexNum-1];
    }

    @Override
    public String getCodeString(int vertexNum) {
        long code = codes[vertexNum-1];
        int len = codeLength[vertexNum-1];
    ...
    public int[] getPathInnerNodes(int vertexNum) {
        return innerNodePathToLeaf[vertexNum-1];
    }
}
