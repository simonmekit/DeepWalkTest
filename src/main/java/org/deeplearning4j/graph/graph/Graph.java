 ...
 * @param <E> Type parameter for edges (type of objects attached to ea/98ch edge)
 * @author Alex Black
 */
public class Graph<V, E> extends BaseGraph<V, E> {
    ...
    public void addEdge(Edge<E> edge) {
        ...
        List<Edge<E>> fromList = edges[edge.getFrom()-1];
        if (fromList == null) {
            fromList = new ArrayList<>();
            edges[edge.getFrom()-1] = fromList;
        }
        ...
        List<Edge<E>> toList = edges[edge.getTo()-1];
        if (toList == null) {
            toList = new ArrayList<>();
            edges[edge.getTo()-1] = toList;
        }
